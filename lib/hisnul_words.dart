...
const DUA_WORDS = const [
  ...
  const Words(
    id:5, 
    english:'taken it from us',
    arabic:  'أَماتَـنا',
  ),
  const Words(
    id:6, 
    english:'and unto Him',
    arabic:  'وَإليه',
  ),
  const Words(
    id:7, 
  ...
  const Words(
    id:10, 
    english:'the right to be worshipped',
    arabic:'إلهَ',
  ),
  const Words(
    id:11, 
